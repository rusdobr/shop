<?php /* Smarty version 2.6.0, created on 2015-08-27 19:17:31
...
, <?php echo $this->_tpl_vars['currency_iso_3']; ?>
		...
		<td><?php echo @constant('ADMIN_PRODUCT_THUMBNAIL'); ?></td>
        <td><?php echo @constant('ADMIN_PRODUCT_AMOUNT'); ?></td>
...
>
 ...
 size=5<?php if ($this->_tpl_vars['products'][$this->_sections['i']['index']][4] > 0): ?> checked<?php endif; ?>>
			...
			<?php if ($this->_tpl_vars['products'][$this->_sections['i']['index']][7] != ""):  echo @constant('ANSWER_YES');  else: ?><font color=red><?php echo @constant('ANSWER_NO'); ?>
                ...
                <td align=center>
                    <input type=text name=amount_<?php echo $this->_tpl_vars['products'][$this->_sections['i']['index']][0]; ?>
                           size=5 value=<?php echo $this->_tpl_vars['products'][$this->_sections['i']['index']][11]; ?>
                        >
                </td>
			<td align=center>
